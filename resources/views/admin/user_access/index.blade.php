            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/admin/user_access') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                        ...
                        <div class="table-responsive">
                                ...
                                @foreach($user_access as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ url('/admin/user_access' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                            ...
                            <div class="pagination-wrapper"> {!! $user_access->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
