                  ...
                  <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                      ...
                      <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Sign up</p>
                        ...
                        <form method="POST" action="{{ url('/registration') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="hidden" name="is_admin" id="is_admin" class="form-control" value="{{ $is_admin }}" />
                            ...
                            <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                <input type="submit" value="Register" class="btn btn-primary btn-lg" style="border-radius: 15px;" />
                            </div>
